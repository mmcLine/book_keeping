...
import com.mmc.book_keeping.tradeType.TradeTypeService;
...
public class OrderController {
    ...
    public String orderSave(@SessionAttribute(UserController.SESSION_USER)User user, String name, Integer tradeType, double amt,
